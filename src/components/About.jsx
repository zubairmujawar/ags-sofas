...
const About = () => {
  return (
    <div className=" h-[120vh] sm:h-[100vh] w-full flex justify-center" >
      {/* <img
        src={aboutImg}
        alt=" home-page-img"
      ...
      <div className=" absolute w-full h-full grid items-center gap-5 sm:grid-cols-10">
        <div className="sm:col-span-6" style={{paddingLeft: "2rem"}}>
          ...
          <h1 className="font-bold sm:text-5xl m-3 text-2xl p-5 self-start">About</h1>
        ...
        <div className=" min-h-[200px] py-4 sm:w-[28rem] sm:px-5 sm:col-span-4">
          <img src={aboutChair} alt="aboutChairImg"  className="sm:w-full w-[80%]"/>  
        </div>
